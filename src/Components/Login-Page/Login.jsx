...
return (
    <div className="w-80 md:w-96 lg:w-[800px] mx-auto mt-8 bg-white flex items-center relative overflow-hidden shadow-xl mb-8">
                {/* register form  */}
                <form className={`p-8 w-full ${register ? 'lg:translate-x-0' : 'lg:-translate-x-full hidden lg:block'} duration-500`}>
                    ...
                    <div className="space-y-2">
                        ...
                        <label htmlFor="u_password" className="block">Confirm Password</label>
                        <input id="u_password" type="u_password" placeholder=".............." min={5} className="p-3 block w-full outline-none border rounded-md invalid:border-red-700 valid:border-black"/>
                    ...
                    <button type="button" className="py-2 px-5 mb-4 mx-auto mt-8 shadow-lg border rounded-md border-black block">Register</button>
                ...
                <form className={`p-8 w-full mr-0 ml-auto duration-500 ${register ? 'lg:translate-x-full hidden lg:block' : ''}`}>
                    ...
                    {/* button type will be submit for handling form submission*/}
                    <button type="button" className="py-2 px-5 mb-4 mx-auto mt-8 shadow-lg border rounded-md border-black block">Login</button>
